...
namespace Driver
{
    ...
    type read_array(const std::uintptr_t address, type* buffer, size_t size) {
        ...
        return DeviceIoControl(driver_handle, IOCTLCodes::read, &req, sizeof(req), &req, sizeof(req), nullptr, nullptr);
    }
    ...
    bool write_memory(const std::uintptr_t addr, const type& value) {
        ...
        return DeviceIoControl(driver_handle, IOCTLCodes::write, &r, sizeof(r), &r, sizeof(r), nullptr, nullptr);
    }
}
