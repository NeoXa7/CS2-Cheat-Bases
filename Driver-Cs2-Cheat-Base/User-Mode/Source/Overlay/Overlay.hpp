...
VOID ShowTitle()
{
    ...
    "  / __/ __|_  ) |   \\ _ _(_)_ _____ _ _   / __| |_  ___ __ _| |_ ",
    " | (__\\__ \\/ /  | |) | '_| \\ V / -_) '_| | (__| ' \\/ -_) _` |  _|",
    "  \\___|___/___| |___/|_| |_|\\_/\\___|_|    \\___|_||_\\___\\__,_|\\__|",
    "                                                                 "
    };

    for (const auto& line : CheatTitle) {
        SetConsoleTextColor(DARK_CYAN);
        std::cout << line << std::endl;
    }

    cout << "  Created By NeoXa7\n";
    ...
    if (CS2::ProcID > 0 && CS2::ClientDll > 0)
    {
        ...
        cout << '\n';
        cout << " [+] Driver Attached Successfully\n";
        cout << '\n';
